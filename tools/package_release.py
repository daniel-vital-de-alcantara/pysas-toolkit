...
FILES = ["pysas.py", "pysas_0_3_2.py", "pysas_ui.py", "ui_worker.py", "ui_support.py", "windows_app.py", "launch_workbench.py", "START_PYSAS_CONSOLE.bat", "START_PYSAS.bat", "START_PYSAS_BROWSER.bat", "START_HERE.txt",
