...
FILES = ["pysas.py", "pysas_ui.py", "ui_worker.py", "ui_support.py", "ui_data.py", "ui_parameters.py", "windows_app.py", "launch_workbench.py", "START_PYSAS_CONSOLE.bat", "START_PYSAS.bat", "START_PYSAS_BROWSER.bat", "START_HERE.txt",
